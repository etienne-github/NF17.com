...
<?php $vCurrentRubrique=$_POST['inputDestRubrique']; ?>;
            

     <div class="crumb_navigation">

     Navigation: <a href="index.php">Accueil</a> &lt; <a href="myAdminAccount.php">Gestion</a> &lt; <span class="current">Nouveau produit de la rubrique <?php echo $vCurrentRubrique; ?></span> 
...
<?php fmenuGauche($vC->fConn);?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Ajout produit dans la rubrique <?php echo $vCurrentRubrique; ?> </div>
...
$vNom=$_POST['nomP'];
$vDesc=$_POST['descP'];
$vCode=intval($_POST['codeP']);
$vPrix=intval($_POST['prixP']);
$vStock=intval($_POST['stockP']);
$vMasse=intval($_POST['masseP']);
$vHauteur=intval($_POST['hauteurP']);
$vLargeur=intval($_POST['largeurP']);
$vProfondeur=intval($_POST['profondeurP']);
	...
	echo "<p><blink><b>".fAjoutProduit($vCode,$vNom,$vPrix,$vDesc,$vStock,$vMasse,$vLargeur,$vHauteur,$vProfondeur,$vC->fConn)."</b></blink></p>"; // ON AJOUTE LA NOUVELLE RUBRIQUE DANS LA TABLE
	fUpdateContenuRubrique($vCode,$vCurrentRubrique,$vC->fConn); //on relie Le produit a la rubrique
	echo "<hr/>";
?>  
   				<br/>
                <br/>
                ...
                <br/>
					...
					<div class="form_row">
					<a href="index.php" class="login">Poursuivre</a>
