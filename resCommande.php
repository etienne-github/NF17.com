...
<title>NF17.com - Nouvelle Commande</title>
...
<?php $vCurrentRubrique=$_POST['inputDestRubrique']; ?>
     ...
     Navigation: <a href="index.php">Accueil</a> &lt; <a href="myCart.php">Panier</a> &lt; <span class="current">Votre commande</span> 
...
<?php fmenuGauche($vC->fConn);?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Ma Commande</div>
...
$vRecu=$_POST['recurrent'];

$vPanier=$_POST['inputPanier'];

$vAdresseNom=$_POST['choiceadresse'];
...
fCommander($_SESSION['login'],$vPanier,$vAdresseNom,$vRecu,$vC->fConn);
?> 
