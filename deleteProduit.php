...
<title>NF17.com - Suppression Produit</title>
...
function submitform()
{
    ...
    document.forms["fdeleteProduit"].submit();
}
</script>
...
<div class="right_menu_corner"></div>
    ...
    Navigation: <a href="index.php">Accueil</a> &lt; <a href="myAdminAccount.php">Gestion</a> &lt; <span class="current">Supprimer un produit</span>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Suppression d'un produit</div>
...
<?php
			...
			?>
				...
				<form method="POST" id="fdeleteProduit" action="resDeleteProduit.php">
              	<div class="login_form">
                   ...
                   <label class="login"><strong>Etes-vous sur de vouloir supprimer le produit <?php echo $vProduit?> ?</strong></label>
                    ...
                    <input type="hidden" name="inputDeleteProduit" value="<?php echo $vProduit; ?>"/>
