...
<title>NF17.com - Suppression Catalogue</title>
...
<div class="right_menu_corner"></div>
    ...
    Navigation: <a href="index.php">Accueil</a> &lt; <a href="myAdminAccount.php">Gestion</a> &lt; <span class="current">Supprimer un catalogue</span>
...
$vCatalogue=$_POST['inputDeleteCatalogue'];


	include "lib_MATTHIEU.php";
	//fdeleteContenuCatalogue($vCatalogue,$vC-fConn); // ON SUPPRIME LE CONTENU DU CATALOGUE
	echo "<p><blink><b>".fdeleteCatalogue($vCatalogue,$vC->fConn)."</b></blink></p>"; //ON SUPPRIME LE CATALOGUE
	echo "<hr/>";
