...
<title>NF17.com - Gestion des Utilisateurs</title>
...
<div class="right_menu_corner"></div>
    ...
    Navigation: <a href="index.php">Accueil</a> &lt; <a href="myAdminAccount.php">Administration</a> &lt; <span class="current">Gestion des utilisateurs</span>
...
<?php fmenuGauche($vC->fConn);?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Utilisateurs</div>
    	...
    	<div class="prod_box_big">
            ...
            <div class="center_prod_box_big">            
                ...
                <form method="POST" id="gestionCatalogue" action="detailCatalogue.php">
					<TABLE width="335" class="catalogue"> 
                    	<TR class="catalogue"><TH width="20%" class="catalogue">Email</TH><TH class="catalogue">Prenom</TH><TH class="catalogue">Nom</TH><TH  class="catalogue">Action</TH></TR>
                        
                       <?php 
					   		fAfficherUser($vC->fConn);
						?>
