   	...
   	<div class="center_title_bar">Catalogues</div>
    	...
    	<div class="prod_box_big">
            ...
            <div class="center_prod_box_big">            
                ...
                <form method="POST" id="gestionCatalogue" action="detailCatalogueClient.php">
					<TABLE width="335" class="catalogue"> 
                    	<TR class="catalogue"><TH width="20%" class="catalogue">Nom</TH><TH class="catalogue">Debut</TH><TH class="catalogue">Fin</TH><TH  class="catalogue">Description</TH><TH class="catalogue">Rubriques</TH></TR>
                        
                       <?php 
					
					   		fAfficherCatalogueClient($vC->fConn);
						?>
