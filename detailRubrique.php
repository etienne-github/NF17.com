...
<title>NF17.com - Catalogue en detail</title>
...
{
    document.forms["newsousrubrique"].submit();
}
...
<option>Euro</option>
    ...
    Navigation: <a href="index.php">Accueil</a> &lt; <a href="myAdminAccount.php">Administration</a> &lt; <a href="gestionCatalogue.php"> Gestion des catalogues</a> &lt; <span class="current">Rubrique <?php echo "$vRubrique " ?>en Details</span>
...
<?php fmenuGauche($vC->fConn);?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Rubrique <?php echo "$vRubrique" ?></div>
    	...
    	<div class="prod_box_big">
            ...
            <div class="center_prod_box_big">            
              	...
              	<div class="login_form_moncatalogue">
                    ...
                    <label class="login" ><strong>Sous-rubriques:</strong></label>
  ...
  <div class="form_row">
					...
					<TABLE width="335" class="catalogue"> 
                    	<TR class="catalogue"><TH  class="catalogue">Sous-Rubrique</TH><TH  class="catalogue">Description</TH><TH class="catalogue">Action</TH></TR>
                        
                       <?php 
					   		

					   		fAfficherSousRubrique($vRubrique,$vC->fConn);
						?>
                    ...
                    <label class="login" ><strong>Produits:</strong></label>
                    
                    </div>
<div class="form_row">
                     <TABLE width="335" class="catalogue"> 
                    <TR class="catalogue"><TH  class="catalogue">Code</TH><TH  class="catalogue">Nom</TH><TH class="catalogue">Prix</TH><TH class="catalogue">Description</TH><TH class="catalogue">stock</TH><TH class="catalogue">actions</TH></TR>
                    
                    	<form method="POST" id="newproduit" action="newProduit.php">  
                        <input type="hidden" name="inputDestRubrique" value="<?php echo $vRubrique; ?>" />
                        </form>
                        
                        <form method="POST" id="newsousrubrique" action="newSousRubrique.php">  
                        <input type="hidden" name="inputDestRubrique" value="<?php echo $vRubrique; ?>" />
                        </form>
                        <?php
							fAfficherProduitRubrique($vRubrique,$vC->fConn);
                        ?>
                     ...
                     <div class="form_row_moncompte">
                         ...
                         <a href="javascript: submitform4()" class="login">Ajouter rubrique</a>
                         
                     
					     <a href="javascript: submitform5()" class="login">Ajouter produit</a>
