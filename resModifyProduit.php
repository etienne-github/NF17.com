...
<div class="right_menu_corner"></div>
     ...
     Navigation: <a href="index.php">Accueil</a> &lt; <a href="myAdminAccount.php">Gestion</a> &lt; <span class="current">Modifier catalogue</span> 
...
<?php fmenuGauche($vC->fConn);?>
   ...
   <?php $vNouveau=$_POST['inputmodifyProduit']; ?>

   <div class="center_content">

   	<div class="center_title_bar">Modifier produit <?php echo $vNouveau;?></div>
...
$vDesc=$_POST['descP'];
$vmasse=$_POST['masseP'];
$vhauteur=$_POST['hauteurP'];
$vprofondeur=$_POST['profondeurP'];
$vlargeur=$_POST['largeurP'];


/* Inscription 
	NB : si aucun login n'est passé, c'est que la page est appelé uniquement pour avoir la liste des inscrits
		sans procéder à une nouvelle inscription*/
