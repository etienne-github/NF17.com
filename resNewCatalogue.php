...
if ($vNom) { 
	...
	echo "<p><blink><b>".fAjoutCatalogue($vNom,$vDateDebut,$vDateFin,$vDesc,$vC->fConn)."</b></blink></p>";
	echo "<hr/>";
}
?>  
   				<br/>
   ...
   <div class="right_content">
   		...
   		<div class="shopping_cart">
            ...
            <div class="cart_icon"><a href="panier.php" title="header=[Checkout] body=[&nbsp;] fade=[on]"><img src="images/shoppingcart.png" alt="" title="" width="48" height="48" border="0" /></a></div>
