...
<title>NF17.com - Identification</title>
...
<div class="right_menu_corner"></div>
    ...
    Navigation: <a href="index.php">Accueil</a> &lt; <span class="current">Identification</span>
...
<?php fmenuGauche($vC->fConn);?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Identification</div>
...
if ($vEmail) { 
	...
	//echo "$vEmail,$vMdp,$vNom,$vPrenom";
	$_SESSION['login']=fLogin($vEmail, $vMdp,$vC->fConn);
	if ((isset($_SESSION['login'])) && (!empty($_SESSION['login'])))
	{
		$_SESSION['droit']=fChmod($vEmail, $vC->fConn);
		echo"<p class=\"resTrue\">Vous etes maintenant identifié comme étant $_SESSION[login] avec le droit $_SESSION[droit]</p>";
			
	}
	else
	{
		echo "<p class=\"resFalse\">Les donnees entrees ne permettent pas de vous identifier</p>";
	}
