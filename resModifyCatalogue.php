...
<?php fmenuGauche($vC->fConn);?>
   ...
   <?php $vNouveau=$_POST['inputModifyCatalogue']; ?>

   <div class="center_content">

   	<div class="center_title_bar">Modifier catalogue <?php echo $vNouveau;?></div>
...
//$_SESSION['poursuivre']='';
fModifierCatalogue($vNouveau,$vNom,$vDateDebut,$vDateFin,$vDesc,$vC->fConn);
