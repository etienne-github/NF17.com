...
$vCode=$_POST['inputProduit'];
$vQte=$_POST['subQte'];
$vPanier=$_POST['choicepanier'];
$vPanier=intval($vPanier);
fAjoutPanier($_SESSION['login'],$vPanier,$vCode,$vQte,$vC->fConn);
?> 
                ...
                <br/>
					...
					<div class="form_row">
					<a href="myCart.php" class="login">Poursuivre</a>
