...
<title>NF17.com - Modification Produit</title>
...
function submitform()
{
	document.forms["modifycatalogue"].debutC.value = document.forms["modifycatalogue"].dateDebut.value;
	document.forms["modifycatalogue"].finC.value = document.forms["modifycatalogue"].dateFin.value;
    document.forms["modifycatalogue"].submit();
}
...
<div class="right_menu_corner"></div>
    ...
    Navigation: <a href="index.php">Accueil</a> &lt; <a href="myAdminAccount.php">Gestion</a> &lt; <span class="current">Modifier un catalogue</span> 
...
<?php
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Modification du Produit <?php echo $vProduit;?></div>
    	...
    	<div class="prod_box_big">
            ...
            <div class="center_prod_box_big">            
				...
				<form method="POST" id="modifycatalogue" action="resModifyProduit.php">
              	<div class="login_form">
                   ...
                   <label class="login"><strong>Ne renseignez que les champs correspondants au informations que vous voulez modifier.</strong></label>
                    ...
                    <label class="login"><strong>Nouveau nom du Produit:</strong></label>
                    ...
                    <label class="login" ><strong>Nouveau Prix TTC:</strong></label>
                    ...
                    <label class="login" ><strong>Nouveau stock:</strong></label>
                    ...
                    <label class="login"><strong>nouvelle Masse:</strong></label>
                    ...
                    <label class="login"><strong>Nouvelle largeur:</strong></label>
                    ...
                    <label class="login"><strong>nouvelle hauteur:</strong></label>
                    ...
                    <label class="login"><strong>Nouvelle profondeur:</strong></label>
