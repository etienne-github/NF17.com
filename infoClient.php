            ...
            <div class="center_prod_box_big">            
              	...
              	<div class="login_form_moncatalogue">
					...
					<TABLE width="335" class="catalogue"> 
                    	<TR class="catalogue"><TH width="20%" class="catalogue">Nom</TH><TH class="catalogue">Prenom</TH><TH  class="catalogue">Email</TH><TH class="catalogue">Adresse de livraison</TH></TR>
                        
                       <?php 
					 		include "lib_PA2.php";
					   		fAfficherInfoClient($vCommande,$vC->fConn);
						?>
						 ...
						 <form method="POST" id='historique' action="historiqueCommandes.php"> 
						 <input type="hidden" name='inputPanier' value="<?php echo $vCodeP; ?>" />
						</form> 
						<a href="javascript: submitform()" class="login">retour</a>
