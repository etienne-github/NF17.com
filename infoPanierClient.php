...
function submitform1()
{
    ...
    document.forms["historique"].submit();
}
</script>
</head>
...
<a href="#"><img src="images/bann2.jpg" alt="" title="" border="0" /></a>
  ...
  <?php 
	...
	$vCommande=$_POST["inputPanier"];

	//$vPanier=$_POST["inputPanier"];
 ...
 ?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">info sur le client</div>
            ...
            <div class="center_prod_box_big">            
              	...
              	<div class="login_form_moncatalogue">
					...
					<TABLE width="335" class="catalogue"> 
                    	<TR class="catalogue"><TH width="20%" class="catalogue">produit</TH><TH class="catalogue">quantite</TH></TR>
                        
                       <?php 
					 		
					   		fAfficherInfoPanier($vCommande,$vC->fConn);
						?>
						 ...
						 <form method="POST" id='historique' action="historiqueCommandeClient.php"> 
						 <input type="hidden" name='inputPanier' value="<?php echo $vCodeP; ?>" />
						</form> 
						<a href="javascript: submitform1()" class="login">retour</a>
