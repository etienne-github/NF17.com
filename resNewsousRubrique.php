...
<title>NF17.com - Nouvelle Sous Rubrique</title>
...
<?php fmenuGauche($vC->fConn);?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Ajout d'une sous rubrique dans <?php echo $vCurrentRubrique; ?> </div>
...
$vDesc=$_POST['descR'];
	...
	echo "<p><blink><b>".fAjoutsousRubrique($vNom,$vDesc,$vCurrentRubrique,$vC->fConn)."</b></blink></p>"; // ON AJOUTE LA NOUVELLE RUBRIQUE DANS LA TABLE
	echo "<hr/>";
?>  
   				<br/>
                <br/>
