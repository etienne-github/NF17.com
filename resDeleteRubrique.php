...
<?php fmenuGauche($vC->fConn);?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Suppression d'une rubrique</div>
...
$vRubrique=$_POST['inputDeleteRubrique'];
$vCatalogue=$_POST["inputCatalogue"];


	include "lib_KENZA.php";

	echo "<p><blink><b>".fdeleteRubrique($vRubrique,$vC->fConn)."</b></blink></p>"; //ON SUPPRIME LA RUBRIQUE
	echo "<hr/>";
...
?>
                ...
                <br/>
					...
					<div class="form_row">
								<form method="POST" id='catalogue' action="detailCatalogue.php"> 
								<input type="hidden" name='inputCatalogue' value="<?php echo $vCatalogue; ?>" />	
								</form>					<a href="javascript: submitform()" class="login">Poursuivre</a>
