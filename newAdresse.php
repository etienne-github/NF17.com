...
<title>NF17.com - Nouvelle Adresse</title>
...
function submitform()
{
    document.forms["newadresse"].submit();
}
</script>
...
<div class="right_menu_corner"></div>
    ...
    Navigation: <a href="index.php">Accueil</a> &lt; <span class="current">Nouvelle Adresse</span>
...
<?php fmenuGauche($vC->fConn);?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Creation de votre Adresse</div>
    	...
    	<div class="prod_box_big">
            ...
            <div class="center_prod_box_big">            
				...
				<form method="POST" id="newadresse" action="resNewAdresse.php">
              	<div class="login_form">
                    ...
                    <label class="login"><strong>Votre nom d'adresse (exemple "Domicile"):</strong></label>
                    <input type="text" class="login_input" name="nomA"  />
                    ...
                    <label class="login" ><strong>Votre rue (exemple "1, rue de la République"):</strong></label>

                    <input type="text" class="login_input" name="rueA" />

                    </div>
                     <div class="form_row">

                    <label class="login" ><strong>Votre ville:</strong></label>

                    <input type="text" class="login_input" name="villeA" />

                    </div>
                     <div class="form_row">

                    <label class="login" ><strong>Votre code postal:</strong></label>

                    <input type="text" class="login_input" name="code_postalA" />

                    </div>
                     <div class="form_row">

                    <label class="login" ><strong>Votre pays:</strong></label>

                    <input type="text" class="login_input" name="paysA" />
