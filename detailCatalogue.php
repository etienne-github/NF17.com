...
function submitform()
{
	//alert(document.forms["newrubrique"].inputDestCatalogue.value);
    document.forms["newrubrique"].submit();
}
...
<option>Euro</option>
    ...
    Navigation: <a href="index.php">Accueil</a> &lt; <a href="myAdminAccount.php">Administration</a> &lt; <a href="gestionCatalogue.php"> Gestion des catalogues</a> &lt; <span class="current">Catalogue <?php echo "$vCatalogue" ?>en Details</span>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Catalogue <?php echo "$vCatalogue" ?> en details</div>
            ...
            <div class="center_prod_box_big">            
              	...
              	<div class="login_form_moncatalogue">
					<TABLE width="335" class="catalogue"> 
                    	<TR class="catalogue"><TH  class="catalogue">Rubrique</TH><TH  class="catalogue">Description</TH><TH class="catalogue">Action</TH></TR>
                        
                       <?php 
					   		
					   		fAfficherDetailCatalogue($vCatalogue,$vC->fConn);
						?>
                    
                    
                     </TABLE>

                      <form method="POST" id="newrubrique" action="newRubrique.php">  
                      <input type="hidden" name="inputDestCatalogue" value="<?php echo $vCatalogue; ?>" />
                      </form>
                 </div>   
                     ...
                     <div class="form_row_moncompte">
                       ...
                       <a href="javascript: submitform()" class="login">Ajouter Rubrique</a>
