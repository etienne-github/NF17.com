...
<div class="right_menu_corner"></div>
 ...
 <?php
   ...
   <div class="center_content">
   	<div class="center_title_bar"><?php echo fgetNomProduit ($vCodeP, $vC->fConn) ?></div>
    	...
    	<div class="prod_box_big">
            ...
            <div class="center_prod_box_big">            
                 ...
                 <a href="javascript:popImage('images/big_pic.jpg','Some Title')" title="header=[Zoom] body=[&nbsp;] fade=[on]"><img src="images/<?php echo fImageProduit($vCodeP, $vC->fConn) ?> " alt="" title="" border="0" /></a>
                 <div class="thumbs">
                 <a href="#" title="header=[Thumb1] body=[&nbsp;] fade=[on]"><img src="images/<?php echo fImageProduit($vCodeP, $vC->fConn) ?> "  alt="" title="" border="0" /></a>
                 <a href="#" title="header=[Thumb2] body=[&nbsp;] fade=[on]"><img src="images/<?php echo fImageProduit($vCodeP, $vC->fConn) ?> "  alt="" title="" border="0" /></a>
                 <a href="#" title="header=[Thumb3] body=[&nbsp;] fade=[on]"><img src="images/<?php echo fImageProduit($vCodeP, $vC->fConn) ?> "  alt="" title="" border="0" /></a>
                 </div>
                 </div>
