...
<title>NF17.com - Nouveau produit</title>
...
function submitform()
{
    document.forms["newProduit"].submit();
}
</script>
...
<div class="right_menu_corner"></div>
    ...
    Navigation: <a href="index.php">Accueil</a> &lt; <a href="myAdminAccount.php">Gestion</a> &lt; <span class="current">Nouvelle rubrique</span> 
...
<?php fmenuGauche($vC->fConn);?>
  ...
  <?php $vRecupRubrique = $_POST["inputDestRubrique"]; ?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Creation d'un produit dans <?php echo $vRecupRubrique;?></div>
    	...
    	<div class="prod_box_big">
            ...
            <div class="center_prod_box_big">            
				...
				<form method="POST" id="newProduit" action="resNewProduit.php">
              	<div class="login_form">
                    ...
                    <label class="login"><strong>Code du produit:</strong></label>
                    <input type="text" class="login_input" name="codeP"  />
                    ...
                    <label class="login" ><strong>Nom du produit:</strong></label>

                    <input type="text" class="login_input" name="nomP" />
                    </div>
					
					<div class="form_row">

                    <label class="login" ><strong>Prix TTC:</strong></label>

                    <input type="text" class="login_input" name="prixP" />
                    </div>
					
					<div class="form_row">

                    <label class="login" ><strong> Description:</strong></label>

                    <input type="text" class="login_input" name="descP" />
                    </div>
					
					<div class="form_row">

                    <label class="login" ><strong>stock:</strong></label>

                    <input type="text" class="login_input" name="stockP" />
                    </div>
                    ...
                    <label class="login"><strong>la Masse:</strong></label>
                    <input type="text" class="login_input" name="masseP"  />
                    ...
                    <label class="login"><strong>la largeur:</strong></label>
                    <input type="text" class="login_input" name="largeurP"  />
                    ...
                    <label class="login"><strong>la hauteur:</strong></label>
                    <input type="text" class="login_input" name="hauteurP"  />
                    ...
                    <label class="login"><strong>la profondeur:</strong></label>
                    <input type="text" class="login_input" name="profondeurP"  />
                    ...
                    <input type="hidden" name="inputDestRubrique" value="<?php echo $vRecupRubrique; ?>" />
                    ...
                    <div class="form_row">
					<a href="javascript: submitform()" class="login">Ajouter</a>
