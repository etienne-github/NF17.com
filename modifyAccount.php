...
function submitform()
{
    document.forms["modifyAccount"].submit();
}
</script>
</head>
...
<?php fmenuGauche($vC->fConn);?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Modification de vos informations personnelles</div>
    	...
    	<div class="prod_box_big">
            ...
            <div class="center_prod_box_big">            
              	...
              	<div class="login_form">
					<div class="form_row">
                    <form method="POST" action="resModifyAccount.php" id="modifyAccount">
					...
					<div class="form_row">
                    <label class="login"><strong>Votre nouvel email:</strong></label>
                    <input type="text" class="login_input" name="newMail" />
                    </div>  
                    <div class="form_row">
                    <label class="login"><strong>Retapez votre nouvel email:</strong></label>
                    <input type="text" class="login_input" name="newMail2" />
                    </div> 
                    <div class="form_row">
                    <label class="login"><strong>Votre nouveau mot de passe:</strong></label>
                    <input type="password" class="login_input" name="newMdp" />
                    </div>
                    
                    <div class="form_row">
                    <label class="login"><strong>Retapez votre nouveau mot de passe:</strong></label>
                    <input type="password" class="login_input" name="newMdp2" />
                    </div>
                      <div class="form_row">
                    <label class="login"><strong>Votre nouveau prenom:</strong></label>
                    <input type="text" class="login_input" name="newPrenom" />
                    </div>
                       <div class="form_row">
                    <label class="login"><strong>Votre nouveau nom:</strong></label>
                    <input type="text" class="login_input" name="newNom" />
                    </div>
                    <br/>
                    <br/>
                    <br/>
                    ...
                    <br/>
                   	...
                   	<div class="form_row">
                    <label class="login"><strong>Pour valider vos modifications,</strong></label>
                    <label class="login"><strong> tapez votre mot de passe*:
                    <input type="password" class="login_input" name="currentMdp" /></strong></label>
                    </form>
                    </div>
                    <div class="form_row">

                    <a href="javascript:submitform()" class="login">Valider</a>
