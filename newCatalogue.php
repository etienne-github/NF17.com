...
<title>NF17.com - Nouveau Catalogue</title>
...
function submitform()
{
	document.forms["newcatalogue"].debutC.value = document.forms["newcatalogue"].dateDebut.value;
	document.forms["newcatalogue"].finC.value = document.forms["newcatalogue"].dateFin.value;
    document.forms["newcatalogue"].submit();
}
</script>
...
<div class="right_menu_corner"></div>
    ...
    Navigation: <a href="index.php">Accueil</a> &lt; <a href="myAdminAccount.php">Gestion</a> &lt; <span class="current">Nouveau catalogue</span> 
...
<?php fmenuGauche($vC->fConn);?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Creation d'un catalogue</div>
    	...
    	<div class="prod_box_big">
            ...
            <div class="center_prod_box_big">            
				...
				<form method="POST" id="newcatalogue" action="resNewCatalogue.php">
              	<div class="login_form">
                    ...
                    <label class="login"><strong>Nom du catalogue:</strong></label>
                    ...
                    <label class="login" ><strong>Date de debut:</strong></label>

                    <script>DateInput('dateDebut', true, 'DD-MON-YYYY')</script>
                    <input type="hidden" class="login_input" name="debutC" value=''/>

                    </div>
                     <div class="form_row">

                    <label class="login" ><strong>Date de fin:</strong></label>

                    <script>DateInput('dateFin', true, 'DD-MON-YYYY')</script>
