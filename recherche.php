...
<!--ICIIIIIIIIIIIIIIIIIIIIIIIII PHP !!!!!!!!!!!!!!!-->
<ul class="left_menu">
...
<a href="#"><img src="images/bann2.jpg" alt="" title="" border="0" /></a>
 ...
 <div class="center_content">
   	...
   	<div class="center_title_bar">Recherche</div>
    	...
    	<div class="prod_box_big">
            ...
            <div class="center_prod_box_big">            
                 ...
                 <form method="POST" id="gestionRubrique" action="detailRubriqueClient.php">                
				<div class="form_row">
                    ...
                    <TR class="catalogue"><TH  class="catalogue">Code</TH><TH  class="catalogue">Nom</TH><TH class="catalogue">Prix</TH><TH class="catalogue">Description</TH><TH class="catalogue">stock</TH><TH class="catalogue">actions</TH></TR>
                        ...
                        <?php
						 $vSearch=$_POST["search"];
							include "lib_PA.php";
							include "lib_MATTHIEU.php";
							frechercheNom ($vSearch,$vC->fConn);
							//frechercheMarque ($vSearch,$vC->fConn)
                        ?>
...
<!--ICIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII PHPPPPPPPPPPPPPPPPPPPPPPPPP-->
...
<div class="cart_icon"><a href="myCart.php" title="header=[Voir mon panier] body=[&nbsp;] fade=[on]"><img src="images/shoppingcart.png" alt="" title="" width="48" height="48" border="0" /></a></div>
...
<a href="detail.php">à propos</a>
<a href="detail.php">plan du site</a>
<a href="detail.php">rss</a>
