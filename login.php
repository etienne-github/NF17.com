...
<?php fmenuGauche($vC->fConn);?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">S'identifier</div>
    	...
    	<div class="prod_box_big">
			...
			<form method="POST" id="flogin" action="resLogin.php"> 
            <div class="center_prod_box_big">            
              	...
              	<div class="login_form">
                    ...
                    <input type="text" class="login_input" name="fEmail" />
                    ...
                    <label class="login" ><strong>Mot de Passe:</strong></label>

                    <input type="password" class="login_input" name="fMdp" />
                    ...
                    <a href="javascript: submitform()" class="login">S'indentifier</a>
                    <a href="newuser.php">Vous n'avez pas encore de compte ?</a>
