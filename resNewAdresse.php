...
$vNom=$_POST['nomA'];
$vRue=$_POST['rueA'];
$vCode_postal=$_POST['code_postalA'];
$vVille=$_POST['villeA'];
$vPays=$_POST['paysA'];



if((isset($vCode_postal))&&(!empty($vCode_postal))&&($vCode_postal!=''))
{
	$vCode_postal=intval($vCode_postal); 
}
else 
{
	$vCode_postal=0;
...
/* Inscription 
	...
	fAjoutAdresse($_SESSION['login'],$vNom,$vRue,$vCode_postal,$vVille,$vPays,$vC->fConn);
...
?>  
                ...
                <br/>
					...
					<div class="form_row">
					<a href="login.php" class="login">S'identifier</a>
