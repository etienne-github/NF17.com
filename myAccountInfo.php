...
<title>NF17.com - Vos informations personnelles</title>
...
<div class="right_menu_corner"></div>
    ...
    Navigation: <a href="index.php">Accueil</a> &lt; <span class="current">Vos informations</span>
...
<?php fmenuGauche($vC->fConn);?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Vos informations</div>
    	...
    	<div class="prod_box_big">
            ...
            <div class="center_prod_box_big">            
              	...
              	<div class="login_form">
                    ...
                    <p><?php echo afficherLogin($_SESSION["login"],$vC->fConn)?></p>
                    ...
                    <p><?php echo afficherPrenom($_SESSION["login"],$vC->fConn); echo " "; echo afficherNom($_SESSION["login"],$vC->fConn)?></p>
                    ...
                    <a href="modifyAccount.php" class="login">Modifier</a>
