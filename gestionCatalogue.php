...
<?php fmenuGauche($vC->fConn);?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Catalogues</div>
            ...
            <div class="center_prod_box_big">            
                ...
                <form method="POST" id="gestionCatalogue" action="detailCatalogue.php">
					<TABLE width="335" class="catalogue"> 
                    	<TR class="catalogue"><TH width="20%" class="catalogue">Nom</TH><TH class="catalogue">Debut</TH><TH class="catalogue">Fin</TH><TH  class="catalogue">Description</TH><TH class="catalogue">Action</TH></TR>
                        
                       <?php 
					   		fAfficherCatalogue($vC->fConn);
						?>
...
<!--="javascript:submitform2('test3                    ')">Modifier</a></form>-->
                     ...
                     <div class="form_row_moncompte">
                       ...
                       <div align="center"><a href="newCatalogue.php" class="moncompte">Ajouter un catalogue</a>
