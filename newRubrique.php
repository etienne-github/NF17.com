...
<?php fmenuGauche($vC->fConn);?>
  ...
  <?php $vRecup = $_POST["inputDestCatalogue"]; ?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Creation d'une rubrique dans <?php echo $vRecup; ?></div>
    	...
    	<div class="prod_box_big">
            ...
            <div class="center_prod_box_big">            
				...
				<form method="POST" id="newrubrique" action="resNewRubrique.php">
              	<div class="login_form">
                    ...
                    <label class="login"><strong>Nom de la rubrique:</strong></label>
                    ...
                    <input type="hidden" name="inputDestCatalogue" value="<?php echo $vRecup; ?>" />
