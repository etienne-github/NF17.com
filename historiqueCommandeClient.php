            ...
            <div class="center_prod_box_big">            
              	...
              	<div class="login_form_moncatalogue">
					...
					<TABLE width="335" class="catalogue"> 
                    	<TR class="catalogue"><TH width="20%"  class="catalogue">Panier</TH><TH  class="catalogue">date</TH><TH class="catalogue">Etat</TH></TR>
                        
                       <?php 
					 	
					   		fAfficherCommandeClient($_SESSION['login'],$vC->fConn);
						?>
