...
<title>NF17.com - Nouvel utilisateur</title>
...
<div class="right_menu_corner"></div>
    ...
    Navigation: <a href="index.php">Accueil</a> &lt; <span class="current">Nouvel utilisateur</span>
...
<?php fmenuGauche($vC->fConn);?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Creation de votre profil</div>
    	...
    	<div class="prod_box_big">
            ...
            <div class="center_prod_box_big">            
				...
				<form method="POST" id="newuser" action="resInscription.php">
              	<div class="login_form">
                    ...
                    <label class="login"><strong>Votre email:</strong></label>
                    <input type="text" class="login_input" name="a"  />
                    ...
                    <label class="login" ><strong>Votre mot de passe:</strong></label>

                    <input type="password" class="login_input" name="b" />

                    </div>
                     <div class="form_row">

                    <label class="login" ><strong>Retapez votre mot de passe:</strong></label>

                    <input type="password" class="login_input" name="c" />

                    </div>
                     <div class="form_row">

                    <label class="login" ><strong>Votre nom:</strong></label>

                    <input type="text" class="login_input" name="d" />

                    </div>
                     <div class="form_row">

                    <label class="login" ><strong>Votre prénom:</strong></label>

                    <input type="text" class="login_input" name="e" />
                    ...
                    <div class="form_row">
					<a href="javascript: submitform()" class="login">S'inscrire</a>
