...
<title>NF17.com - Substitution utilisateur</title>
...
<option>Euro</option>
     ...
     Navigation: <a href="index.php">Accueil</a> &lt; <a href="myAdminAccount.php">Gestion</a> &lt; <span class="current">Substitution utilisateur</span> 
...
<?php fmenuGauche($vC->fConn);?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Substitution utilisateur</div>
...
$vUser=$_POST['inputUser'];
$vMdp =$_POST['inputMdp'];




fSubLogin($vUser,$vMdp);
