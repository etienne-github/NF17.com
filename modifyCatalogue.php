...
<title>NF17.com - Modification Catalogue</title>
...
<?php
				$vCatalogue=$_POST["inputCatalogue"];
			?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Modification du catalogue <?php echo $vCatalogue;?></div>
    	...
    	<div class="prod_box_big">
            ...
            <div class="center_prod_box_big">            
				...
				<form method="POST" id="modifycatalogue" action="resModifyCatalogue.php">
              	<div class="login_form">
                   ...
                   <label class="login"><strong>Ne renseignez que les champs correspondants au informations que vous voulez modifier.</strong></label>
                    ...
                    <label class="login"><strong>Nouveau nom du catalogue:</strong></label>
                    ...
                    <div class="form_row">
                    <label class="login" ><strong>Nouvelle date de debut:</strong></label>

                    <script>DateInput('dateDebut', true, 'YYYY-MM-DD','<?php echo date("Y-m-d",strtotime(fgetDateDebut($vCatalogue,$vC->fConn))) ?>')</script>
                    <input type="hidden" class="login_input" name="debutC" value=''/>

                    </div>
                     <div class="form_row">

                    <label class="login" ><strong>Nouvelle date de fin:</strong></label>

                    <script>DateInput('dateFin', true, 'YYYY-MM-DD','<?php echo date("Y-m-d",strtotime(fgetDateFin($vCatalogue,$vC->fConn))) ?>')</script>
                    <input type="hidden" class="login_input" name="finC" value=''/>
                    ...
                    <input type="hidden" name="inputModifyCatalogue" value="<?php echo $vCatalogue; ?>"/> 
