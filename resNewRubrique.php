...
function submitform()
{
    document.forms["poursuivre"].submit();
}
</script>
...
<?php fmenuGauche($vC->fConn);?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Creation catalogue</div>
...
$vCurrentCatalogue=$_POST['inputDestCatalogue'];
$vNom=$_POST['nomR'];
$vDesc=$_POST['descR'];
	...
	echo "<p><blink><b>".fAjoutRubrique($vNom,$vDesc,$vC->fConn)."</b></blink></p>"; // ON AJOUTE LA NOUVELLE RUBRIQUE DANS LA TABLE
	fUpdateContenuCatalogue($vNom,$vCurrentCatalogue,$vC->fConn); //ON RELIE LA RUBRIQUE AU CATALOGUE
	echo "<hr/>";
?>  
<form action="detailCatalogue.php" method="POST" id="poursuivre">
<input type="hidden" class="login_input" name="inputCatalogue" value="<?php echo $vCurrentCatalogue;?>"/>
</form>
   				<br/>
                <br/>
                <br/>
                <br/>
					...
					<div class="form_row">
					<a href="javascript: submitform()" class="login">Poursuivre</a>
