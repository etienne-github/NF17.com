...
<title>NF17.com - Nouvelle rubrique</title>
...
<?php fmenuGauche($vC->fConn);?>
  ...
  <?php $vRecupRubrique = $_POST["inputDestRubrique"]; ?>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Creation d'une rubrique dans <?php echo $vRecupRubrique;?></div>
    	...
    	<div class="prod_box_big">
            ...
            <div class="center_prod_box_big">            
				...
				<form method="POST" id="newrubrique" action="resNewsousRubrique.php">
              	<div class="login_form">
                    ...
                    <label class="login"><strong>Nom de la sous rubrique:</strong></label>
                    <input type="text" class="login_input" name="nomR"  />
                    ...
                    <input type="text" class="login_input" name="descR" />
                    </div>
