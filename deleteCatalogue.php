...
function submitform()
{
    ...
    document.forms["fdeletecatalogue"].submit();
}
</script>
...
<?php
			...
			?>
				...
				<form method="POST" id="fdeletecatalogue" action="resDeleteCatalogue.php">
              	<div class="login_form">
                   ...
                   <label class="login"><strong>Etes-vous sur de vouloir supprimer le catalogue <?php echo $vCatalogue?> ?</strong></label>
                    ...
                    <input type="hidden" name="inputDeleteCatalogue" value="<?php echo $vCatalogue; ?>"/>
                    ...
                    <div class="form_row">
                    <a href="gestionCatalogue.php" class="login">Non</a>
