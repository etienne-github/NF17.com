...
<title>NF17.com - Suppression Rubrique</title>
...
function submitform()
{
    ...
    document.forms["fdeleterubrique"].submit();
}
</script>
...
<div class="right_menu_corner"></div>
    ...
    Navigation: <a href="index.php">Accueil</a> &lt; <a href="myAdminAccount.php">Gestion</a> &lt; <span class="current">Supprimer une rubrique</span>
   ...
   <div class="center_content">
   	...
   	<div class="center_title_bar">Suppression d'un catalogue</div>
...
<?php
				...
				$vCatalogue=$_POST["Catalogue"];
			?>

				<form method="POST" id="fdeleterubrique" action="resDeleteRubrique.php">
              	<div class="login_form">
                   ...
                   <label class="login"><strong>Etes-vous sur de vouloir supprimer la rubrique <?php echo $vRubrique?> ?</strong></label>
                    ...
                    <input type="hidden" name="inputDeleteRubrique" value="<?php echo $vRubrique; ?>"/>
                    ...
                    <div class="form_row">
                    <a href="gestionRubrique.php" class="login">Non</a>						
					<input type="hidden" name='inputCatalogue' value="<?php echo $vCatalogue; ?>" />						
					<a href="javascript: submitform()" class="login">Oui</a>
